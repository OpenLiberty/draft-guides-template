...
The what you'll learn section is where you will be writing about what the user will learn in a meaningful introduction paragraph. 

Follow the introduction paragraph with more details of what the user will learn, but still keep it brief. See the https://openliberty.io/guides/rest-intro.html[REST guide] at as an exemplar guide.
//-----------------------------------------------------
